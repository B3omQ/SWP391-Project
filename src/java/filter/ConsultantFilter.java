...
@WebFilter(filterName = "ConsultantFilter", servletNames = {"ConsultantCustomerManager", "ConsultantProfile", "CustomerReviewManager", "ChatLogCustomer",})
public class ConsultantFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        try {
            ...
            if (staff == null || staff.getRoleId().getId() != 2 ||session.getAttribute("account") != null) {
