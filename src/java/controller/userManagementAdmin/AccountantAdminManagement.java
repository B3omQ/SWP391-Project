 ...
 * @author JIGGER
 */
public class AccountantAdminManagement extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int totalRecords = adao.countTotalStaffRecords(1);
            int totalPages = (int) Math.ceil(totalRecords * 1.0 / recordsPerPage);

            List<Staff> staffList = adao.getAllStaff(offset, recordsPerPage, phoneSearch, 1);
        ...
        request.getRequestDispatcher("./admin/accountantAdminManagement.jsp").forward(request, response);
    }
