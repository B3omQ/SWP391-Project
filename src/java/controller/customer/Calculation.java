...
public class Calculation extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
        ...
        Map<Integer, String> depServiceNameMap = new HashMap<>(); // Thêm map để lưu tên gói
        ...
        for (DepService dep : depServices) {
            ...
            depServiceNameMap.put(dep.getId(), dep.getDepServiceName()); // Lưu tên gói

            System.out.println("✅ DepId: " + dep.getId() + ", DepServiceName: " + dep.getDepServiceName() + 
                              ", SavingRate: " + dep.getSavingRate() + ", Interest: " + interest + 
        ...
        session.setAttribute("depServiceNameMap", depServiceNameMap); // Thêm vào session
