        ...
        <header id="topnav" class="navigation sticky">
            <div class="container">
                ...
                <ul class="dropdowns list-inline mb-0">
                    ...
                    <li class="list-inline-item mb-0 ms-1">
                        <a href="AuthServlet" class="btn btn-pills btn-soft-primary">
                                ...
                                <li class="has-submenu parent-menu-item">
                                    ...
                                    <ul class="submenu">
                                        ...
                                        <li><a href="
                                               ...
                                               ${pageContext.request.contextPath}/auth/template/login.jsp" class="sub-menu-item">Login</a></li>
                                        <li><a href="
                            ...
                            <div class="col-md-4 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                                ...
                                <ul class="list-unstyled footer-list mt-4">
                                    ...
                                    <li><a href="blogs.html" class="text-foot"><i class="mdi mdi-chevron-right me-1"></i>
                                            Blog</a></li>
                                    <li>
                                        <a href="${pageContext.request.contextPath}/auth/template/login.jsp" class="text-foot">
