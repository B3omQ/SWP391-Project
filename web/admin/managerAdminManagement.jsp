        ...
        <div class="page-wrapper doctris-theme toggled">
            ...
            <main class="page-content bg-light">   
                ...
                <div class="container-fluid">
                    <div class="layout-specing">
                        ...
                        <div class="row align-items-center">
                            <!-- Title & Breadcrumb -->
                            <div class="col-md-6">
                                <h5 class="mb-0">Trang thông tin quản lí</h5>
                            ...
                            <!-- Search form -->
                            <div class="col-md-6">
                                <form id="search" action="manager-admin-management" method="get" class="d-flex">
                                    <input
                            ...
                            <table>
                                ...
                                <tbody>
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <c:forEach var="manager" items="${staffList}">
                                                <tr>
                                                    <td>${manager.id}</td>
                                                    <td style="max-width: 100px;">
                                                        <div class ="photo-div">
                                                            <img src="${manager.image}" class="photo" alt="Customer Image" />
                                                        </div>
                                                    </td>
                                                    <td class="text-truncate" style="max-width: 120px;">${manager.fullname}</td>
                                                    <td class="text-truncate" style="max-width: 120px;">${manager.phone}</td>
                                                    <td>${manager.gender}</td>
                                                    <td class="text-center align-middle">
                                                        <div class="row justify-content-center">
                                                            <div class="col-auto">
                                                                <button type="button" class="btn btn-info btn-md" data-bs-toggle="modal"
                                                                        data-bs-target="#detailsModal${manager.id}">
                                                                    <i class="fas fa-eye"></i>
                                                                </button>
                                                            </div>
                                                            <div class="col-auto">
                                                                <button data-bs-toggle="modal" data-bs-target="#editModal${manager.id}" 
                                                                        class="btn btn-primary btn-md">
                                                                    <i class="fas fa-edit"></i>
                                                                </button>
                                                            </div>
                                                            <div class="col-auto">
                                                                <form action="manager-admin-management" method="post" id="deleteManager-${manager.id}">
                                                                    <input name="deleteId" value="${manager.id}" type="hidden">
                                                        ...
                                                        <jsp:include page="template/editManager.jsp">
                                                            ...
                                                            <jsp:param name="gender" value="${manager.gender}" />
                                                            <jsp:param name="dob" value="${manager.dob}" />
                                                            <jsp:param name="phone" value="${manager.phone}" />
                                                            <jsp:param name="address" value="${manager.address}" />
                                                        </jsp:include>           
                                                    </td>
                                                </tr>
                                                <!-- Details Modal -->
                                            <div class="modal fade" id="detailsModal${manager.id}" tabindex="-1" aria-labelledby="detailsModalLabel${manager.id}" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header bg-danger text-white">
                                                            <h1 class="modal-title fs-5" id="detailsModalLabel${manager.id}">Thông tin chung</h1>
                                                            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <div class="profile-header text-center">
                                                                <img src="${manager.image}" alt="Customer Image" class="profile-image">
                                                                <h2>${manager.firstname} ${manager.lastname}</h2>
                                                                <p class="text-muted">Vai trò: quản lí</p>
                                                            </div>
                                                            <div class="profile-info">
                                                                <p><strong>Mã id:</strong> ${manager.id}</p>
                                                                <p><strong>Email liên hệ:</strong> ${manager.email}</p>
                                                                <p><strong>Địa chỉ:</strong> ${manager.address}</p>
                                                                <p><strong>Số điện thoại:</strong> ${manager.phone}</p>
                                                                <p><strong>Ngày khai sinh:</strong> ${manager.dob}</p>
                ...
                <nav aria-label="Page navigation" class="mt-4">
                    ...
                    <c:choose>
                        <c:when test="${totalPages > 10}">
                            <form method="get" action="manager-admin-management" class="d-flex justify-content-center mt-2">
