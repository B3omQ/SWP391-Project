...
<html lang="en">
    ...
    <style>
        ...
        .card-body .link {
            margin-top: auto; /* Đẩy "Tìm Hiểu Thêm" xuống cuối */
        }
        .chat-icon{
            position: fixed;
            bottom: 40px;
                        ...
                        <li class="list-inline-item mb-0 ms-1">
                            <div class="dropdown dropdown-primary">
                                <c:if test="${sessionScope.staff.roleId.id == 1}">
                                    <button type="button" class="btn btn-pills btn-soft-primary dropdown-toggle p-0"
                                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                                            src="${staff.image}" class="avatar avatar-ex-small rounded-circle"
                                            alt=""></button>
                                    <div class="dropdown-menu dd-menu dropdown-menu-end bg-white shadow border-0 mt-3 py-3"
                                         style="min-width: 200px;">
                                        <a class="dropdown-item d-flex align-items-center text-dark" href="">
                                        ...
                                        <a class="dropdown-item text-dark" href="doctor-dashboard.html"><span
                                                class="mb-0 d-inline-block me-1"><i
                                                    class="uil uil-dashboard align-middle h6"></i></span> Dashboard</a>
                                        <a class="dropdown-item text-dark" href="./Disbursement"><span
                                                class="mb-0 d-inline-block me-1"><i
                                                    class="uil uil-setting align-middle h6"></i></span> Profile Settings</a>
                                        <div class="dropdown-divider border-top"></div>
                ...
                <div id="navigation">
                    ...
                    <ul class="navigation-menu nav-left nav-light">
                        ...
                        <li class="has-submenu parent-menu-item">
                            ...
                            <ul class="submenu">
                                <li><a href="patient-dashboard.html" class="sub-menu-item">content</a></li>
                                <li><a href="patient-dashboard.html" class="sub-menu-item">content</a></li>
                                <li><a href="patient-dashboard.html" class="sub-menu-item">content</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="has-submenu parent-parent-menu-item"><a href="javascript:void(0)">Các công cụ và tiện ích</a><span
                            ...
                            <ul class="submenu">
                                ...
                                <li><a href="OnlineSupport" class="sub-menu-item">Hỗ trợ</a></li>
