    ...
    <body>
                                            ...
                                            <tbody>
                                                ...
                                                <c:forEach var="staff" items="${staffs}">
                                                    <tr>
                                                        ...
                                                        <td>${staff.gender}</td>
                                                        <td>
                                                            <fmt:parseDate  value="${staff.dob}"  type="date" pattern="yyyy-MM-dd" var="parsedDate" />
                                                        ...
                                                        <td>${staff.address}</td>
                                                        <td>${staff.salary}</td>
                                                        <td>${staff.roleId != null ? staff.roleId.name : 'No Role'}</td>
                                                        <td>                                                           
        ...
        <script>
                                            function editStaff(ID) {
                                                window.location.href = `editStaffInfo?uid=` + ID;
                                            }
        </script>
