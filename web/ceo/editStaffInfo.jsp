                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <select id="role" class="form-control" name="role" required>
                                                            <option value="Admin" <c:if test="${staff.roleId.id == 1}">selected</c:if>>Admin</option>
                                                            <option value="Accountant" <c:if test="${staff.roleId.id == 2}">selected</c:if>>Accountant</option>
                                                            <option value="Sale" <c:if test="${staff.roleId.id == 3}">selected</c:if>>Sale</option>  
                                                            <option value="Manager" <c:if test="${staff.roleId.id == 4}">selected</c:if>>Manager</option>  
                                                            </select>
                                                        </div>
                                                    </div>        
