                            ...
                            <div class="col-10 mt-4">
                                <div class="card login-page bg-white shadow mt-4 rounded border-0">
                                    <div class="card-body">
                                        ...
                                        <form action="<%= request.getContextPath() %>/addUser" method="post" class="login-form mt-4">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="password" class="form-control" name="pass" value="${user.email}">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-control" name="gender" required>
                                                            ...
                                                            <option value="Other" >Other</option>F
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <select id="role" class="form-control" name="role" required>
                                                            ...
                                                            <option value="CRMSpecialist" >CRMSpecialist</option>                                                            
                                                            </select>
                                                        </div>
                                                    </div>
