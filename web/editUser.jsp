                            ...
                            <div class="col-10 mt-4">
                                <div class="card login-page bg-white shadow mt-4 rounded border-0">
                                    <div class="card-body">
                                        ...
                                        <form action="<%= request.getContextPath() %>/editUser" method="post" class="login-form mt-4">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-control" name="gender" required>
                                                            ...
                                                            <option value="Other" ${user.gender == 'Other' ? 'selected' : ''}>Other</option>F
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <select id="role" class="form-control" name="role" required>
                                                            <option value="Admin" <c:if test="${user.role.roleName == 'Admin'}">selected</c:if>>Admin</option>
                                                            <option value="Customer" <c:if test="${user.role.roleName == 'Customer'}">selected</c:if>>Customer</option>
                                                            <option value="Consultant" <c:if test="${user.role.roleName == 'Consultant'}">selected</c:if>>Consultant</option>
                                                            <option value="Accountant" <c:if test="${user.role.roleName == 'Accountant'}">selected</c:if>>Accountant</option>
                                                            <option value="CRMSpecialist" <c:if test="${user.role.roleName == 'CRMSpecialist'}">selected</c:if>>CRMSpecialist</option>                                                            
                                                            </select>
                                                        </div>
                                                    </div>
