                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3 position-relative">
                                                ...
                                                <span class="position-absolute top-50 end-0 translate-middle-y pe-3 cursor-pointer" onclick="togglePassword('password', 'togglePasswordIcon1')"style="padding-top: 30px;">
                                                    <i id="togglePasswordIcon1" class="mdi mdi-eye-outline"></i>
                                                </span>
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3 position-relative">
                                                ...
                                                <span class="position-absolute top-50 end-0 translate-middle-y pe-3 cursor-pointer" onclick="togglePassword('password2', 'togglePasswordIcon2')" style="padding-top: 30px;">
                                                    <i id="togglePasswordIcon2" class="mdi mdi-eye-outline"></i>
                                                </span>
